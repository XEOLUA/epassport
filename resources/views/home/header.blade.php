...
{{--                            {{explode("@",Auth::user()->email)[0]}}[{{ ('Вихід') }}]--}}
                            <center style="cursor:pointer">
                                <svg aria-hidden="true"  focusable="false" data-prefix="fas" data-icon="sign-out-alt" class="svg-inline--fa fa-sign-out-alt fa-w-16 svg_exit" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <title>Вихід</title>
